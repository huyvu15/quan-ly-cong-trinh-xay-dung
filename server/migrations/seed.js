  ...
  try {
    ...
    const projects = [
      ...
      },
      {
        ...
        location: '258 Đường Nguyễn Huệ, Quận 1, TP.HCM',
        start_date: '2024-06-01',
        end_date: '2026-05-31',
        status: 'active',
        description: 'Tòa nhà văn phòng 40 tầng với diện tích 50,000m²'
      },
      {
        name: 'Khu liên hợp thể thao Đông Á',
        location: '159 Đường Lê Đức Thọ, Quận Gò Vấp, TP.HCM',
        start_date: '2024-07-01',
        end_date: '2025-12-31',
        status: 'active',
        description: 'Khu liên hợp thể thao với sân bóng đá, bể bơi, phòng gym'
      },
      {
        name: 'Trung tâm logistics Cảng Sài Gòn',
        location: 'Khu công nghiệp Hiệp Phước, Nhà Bè, TP.HCM',
        start_date: '2023-12-01',
        end_date: '2024-11-30',
        status: 'completed',
        description: 'Trung tâm logistics với kho bãi 20,000m²'
      },
      {
        name: 'Chung cư Diamond Residence',
        location: '369 Đường Võ Văn Tần, Quận 3, TP.HCM',
        start_date: '2024-08-01',
        end_date: '2026-07-31',
        status: 'active',
        description: 'Chung cư cao cấp 30 tầng với 400 căn hộ'
      },
      {
        name: 'Trường đại học Công nghệ',
        location: '741 Đường Nguyễn Kiệm, Quận Phú Nhuận, TP.HCM',
        start_date: '2024-09-01',
        end_date: '2026-08-31',
        status: 'active',
        description: 'Trường đại học 8 tầng với 100 phòng học và phòng thí nghiệm'
      },
      {
        name: 'Khu nghỉ dưỡng biển Nha Trang',
        location: 'Bãi biển Trần Phú, Nha Trang, Khánh Hòa',
        start_date: '2024-10-01',
        end_date: '2026-09-30',
        status: 'active',
        description: 'Khu nghỉ dưỡng 5 sao với 150 villa và resort'
      },
      {
        name: 'Nhà ga sân bay Long Thành',
        location: 'Sân bay Long Thành, Đồng Nai',
        start_date: '2023-08-01',
        end_date: '2024-07-31',
        status: 'completed',
        description: 'Nhà ga hành khách với công suất 25 triệu lượt/năm'
      }
    ];
    ...
    // Thêm nhà cung cấp (15 nhà cung cấp)
    const suppliers = [
      {
      ...
      {
        name: 'Công ty Bê Tông Tươi Miền Nam',
        contact_person: 'Phan Văn L',
        phone: '0901234568',
        email: 'contact@betongmiennam.com',
        address: '852 Đường Tân Sơn Nhì, Tân Phú, TP.HCM',
        tax_code: '0999000111'
      },
      {
        name: 'Công ty Kính Xây Dựng Việt Nam',
        contact_person: 'Võ Thị M',
        phone: '0912345679',
        email: 'sales@kinhxaydung.com',
        address: '963 Đường Nguyễn Xiển, Thanh Xuân, Hà Nội',
        tax_code: '0100111222'
      },
      {
        name: 'Công ty Thiết Bị Vệ Sinh TOTO',
        contact_person: 'Đinh Văn N',
        phone: '0923456780',
        email: 'info@toto.vn',
        address: '147 Đường Nguyễn Văn Cừ, Long Biên, Hà Nội',
        tax_code: '0111222333'
      },
      {
        name: 'Công ty Thang Máy Mitsubishi',
        contact_person: 'Bùi Thị O',
        phone: '0934567891',
        email: 'contact@mitsubishi-elevator.vn',
    ...
    const materials = [
      ...
      { code: 'KINH-CUONG', name: 'Kính cường lực 10mm', unit: 'm²', category: 'Kính', min_stock: 100 },
      { code: 'KINH-THUONG', name: 'Kính thường 5mm', unit: 'm²', category: 'Kính', min_stock: 200 },
      { code: 'KINH-HOP', name: 'Kính hộp cách nhiệt', unit: 'm²', category: 'Kính', min_stock: 80 },
      { code: 'BETONG-TUOI', name: 'Bê tông tươi M200', unit: 'm³', category: 'Bê tông', min_stock: 30 },
      { code: 'BETONG-M250', name: 'Bê tông tươi M250', unit: 'm³', category: 'Bê tông', min_stock: 25 },
      { code: 'BETONG-M300', name: 'Bê tông tươi M300', unit: 'm³', category: 'Bê tông', min_stock: 20 },
      { code: 'VESINH-BON', name: 'Bồn cầu vệ sinh', unit: 'cái', category: 'Vệ sinh', min_stock: 50 },
      { code: 'VESINH-LAVABO', name: 'Lavabo', unit: 'cái', category: 'Vệ sinh', min_stock: 50 },
      { code: 'VESINH-VOI', name: 'Vòi nước', unit: 'cái', category: 'Vệ sinh', min_stock: 100 },
      { code: 'VESINH-SEN', name: 'Sen tắm', unit: 'cái', category: 'Vệ sinh', min_stock: 80 },
      { code: 'THANG-MAY', name: 'Thang máy', unit: 'bộ', category: 'Thiết bị', min_stock: 5 },
      { code: 'DIEU-HOA', name: 'Điều hòa không khí', unit: 'cái', category: 'Thiết bị', min_stock: 30 },
      { code: 'QUAT-TREO', name: 'Quạt treo tường', unit: 'cái', category: 'Thiết bị', min_stock: 50 }
    ];
    ...
    const receipts = [
      ...
      {
        receipt_number: 'PN-2024-016',
        project_id: projectIds['Tòa nhà văn phòng Sky Tower'],
        supplier_id: supplierIds['Công ty Thép Việt Nam'],
        receipt_date: '2024-09-05',
        total_amount: 185000000,
        notes: 'Nhập thép cho khung nhà',
        items: [
          { material_code: 'THEP-D16', quantity: 6000, unit_price: 22000 },
          { material_code: 'THEP-D18', quantity: 4000, unit_price: 24000 },
          { material_code: 'THEP-D20', quantity: 3000, unit_price: 26000 }
        ]
      },
      {
        receipt_number: 'PN-2024-017',
        project_id: projectIds['Khu liên hợp thể thao Đông Á'],
        supplier_id: supplierIds['Công ty Bê Tông Tươi Miền Nam'],
        receipt_date: '2024-09-15',
        total_amount: 125000000,
        notes: 'Nhập bê tông tươi',
        items: [
          { material_code: 'BETONG-TUOI', quantity: 200, unit_price: 1500000 },
          { material_code: 'BETONG-M250', quantity: 150, unit_price: 1600000 },
          { material_code: 'BETONG-M300', quantity: 100, unit_price: 1700000 }
        ]
      },
      {
        receipt_number: 'PN-2024-018',
        project_id: projectIds['Chung cư Diamond Residence'],
        supplier_id: supplierIds['Công ty Kính Xây Dựng Việt Nam'],
        receipt_date: '2024-09-25',
        total_amount: 95000000,
        notes: 'Nhập kính cho cửa sổ',
        items: [
          { material_code: 'KINH-CUONG', quantity: 500, unit_price: 180000 },
          { material_code: 'KINH-HOP', quantity: 300, unit_price: 250000 }
        ]
      },
      {
        receipt_number: 'PN-2024-019',
        project_id: projectIds['Trường đại học Công nghệ'],
        supplier_id: supplierIds['Công ty Thiết Bị Vệ Sinh TOTO'],
        receipt_date: '2024-10-05',
        total_amount: 68000000,
        notes: 'Nhập thiết bị vệ sinh',
        items: [
          { material_code: 'VESINH-BON', quantity: 80, unit_price: 2500000 },
          { material_code: 'VESINH-LAVABO', quantity: 100, unit_price: 1500000 },
          { material_code: 'VESINH-VOI', quantity: 150, unit_price: 800000 }
        ]
      },
      {
        receipt_number: 'PN-2024-020',
        project_id: projectIds['Khu nghỉ dưỡng biển Nha Trang'],
        supplier_id: supplierIds['Công ty Thang Máy Mitsubishi'],
        receipt_date: '2024-10-15',
        total_amount: 450000000,
        notes: 'Nhập thang máy cho resort',
        items: [
          { material_code: 'THANG-MAY', quantity: 4, unit_price: 112500000 }
        ]
      },
      {
        receipt_number: 'PN-2024-021',
        project_id: projectIds['Tòa nhà văn phòng Sky Tower'],
        supplier_id: supplierIds['Công ty Kính Xây Dựng Việt Nam'],
        receipt_date: '2024-10-25',
        total_amount: 185000000,
        notes: 'Nhập kính mặt tiền',
        items: [
          { material_code: 'KINH-CUONG', quantity: 800, unit_price: 180000 },
          { material_code: 'KINH-HOP', quantity: 200, unit_price: 250000 }
        ]
      },
      {
        receipt_number: 'PN-2024-022',
        project_id: projectIds['Chung cư Diamond Residence'],
        supplier_id: supplierIds['Công ty Thiết Bị Vệ Sinh TOTO'],
        receipt_date: '2024-11-05',
        total_amount: 125000000,
        notes: 'Nhập thiết bị vệ sinh cho căn hộ',
        items: [
          { material_code: 'VESINH-BON', quantity: 150, unit_price: 2500000 },
          { material_code: 'VESINH-SEN', quantity: 200, unit_price: 1200000 }
        ]
      },
      {
        receipt_number: 'PN-2024-023',
        project_id: projectIds['Trường đại học Công nghệ'],
        supplier_id: supplierIds['Công ty Vật Tư Điện Nước'],
        ...
        notes: 'Nhập vật tư điện nước',
        items: [
          { material_code: 'ONG-NUOC-42', quantity: 600, unit_price: 35000 },
          { material_code: 'DAY-DIEN-2.5', quantity: 3000, unit_price: 12000 },
          { material_code: 'DAY-DIEN-4', quantity: 2000, unit_price: 15000 }
        ]
      },
      {
        receipt_number: 'PN-2024-024',
        project_id: null,
        supplier_id: supplierIds['Công ty Bê Tông Tươi Miền Nam'],
        receipt_date: '2024-11-25',
        total_amount: 95000000,
        notes: 'Nhập bê tông cho kho trung tâm',
        items: [
          { material_code: 'BETONG-TUOI', quantity: 300, unit_price: 1500000 },
          { material_code: 'BETONG-M250', quantity: 200, unit_price: 1600000 }
        ]
      },
      {
        receipt_number: 'PN-2024-025',
        project_id: projectIds['Khu liên hợp thể thao Đông Á'],
        supplier_id: supplierIds['Công ty Vật Liệu Xây Dựng ABC'],
        receipt_date: '2024-12-05',
        total_amount: 165000000,
        notes: 'Nhập vật tư tổng hợp',
        items: [
          { material_code: 'XM-PC40', quantity: 400, unit_price: 85000 },
          { material_code: 'THEP-D12', quantity: 5000, unit_price: 19000 },
          { material_code: 'GACH-ON', quantity: 15000, unit_price: 1800 },
          { material_code: 'CAT-XAY', quantity: 180, unit_price: 250000 }
        ]
      }
    ];
    ...
    const issues = [
      ...
      {
        issue_number: 'PX-2024-013',
        project_id: projectIds['Tòa nhà văn phòng Sky Tower'],
        issue_date: '2024-09-10',
        purpose: 'Xuất vật tư cho thi công khung nhà',
        approved_by: 'Võ Văn Giám Đốc',
        items: [
          { material_code: 'THEP-D16', quantity: 3000 },
          { material_code: 'THEP-D18', quantity: 2000 },
          { material_code: 'BETONG-M300', quantity: 50 }
        ]
      },
      {
        issue_number: 'PX-2024-014',
        project_id: projectIds['Khu liên hợp thể thao Đông Á'],
        issue_date: '2024-09-20',
        purpose: 'Xuất bê tông cho đổ sân bóng',
        approved_by: 'Đinh Văn Trưởng Ban',
        items: [
          { material_code: 'BETONG-TUOI', quantity: 100 },
          { material_code: 'BETONG-M250', quantity: 80 }
        ]
      },
      {
        issue_number: 'PX-2024-015',
        project_id: projectIds['Chung cư Diamond Residence'],
        issue_date: '2024-10-01',
        purpose: 'Xuất kính cho lắp cửa sổ',
        approved_by: 'Bùi Thị Giám Đốc',
        items: [
          { material_code: 'KINH-CUONG', quantity: 250 },
          { material_code: 'KINH-HOP', quantity: 150 }
        ]
      },
      {
        issue_number: 'PX-2024-016',
        project_id: projectIds['Trường đại học Công nghệ'],
        issue_date: '2024-10-10',
        purpose: 'Xuất thiết bị vệ sinh cho phòng học',
        approved_by: 'Phan Văn Hiệu Trưởng',
        items: [
          { material_code: 'VESINH-BON', quantity: 40 },
          { material_code: 'VESINH-LAVABO', quantity: 50 },
          { material_code: 'VESINH-VOI', quantity: 80 }
        ]
      },
      {
        issue_number: 'PX-2024-017',
        project_id: projectIds['Tòa nhà văn phòng Sky Tower'],
        issue_date: '2024-10-20',
        purpose: 'Xuất kính cho mặt tiền',
        approved_by: 'Võ Văn Giám Đốc',
        items: [
          { material_code: 'KINH-CUONG', quantity: 400 },
          { material_code: 'KINH-HOP', quantity: 100 }
        ]
      },
      {
        issue_number: 'PX-2024-018',
        project_id: projectIds['Chung cư Diamond Residence'],
        issue_date: '2024-11-10',
        purpose: 'Xuất thiết bị vệ sinh cho căn hộ',
        approved_by: 'Bùi Thị Giám Đốc',
        items: [
          { material_code: 'VESINH-BON', quantity: 75 },
          { material_code: 'VESINH-SEN', quantity: 100 }
        ]
      },
      {
        issue_number: 'PX-2024-019',
        project_id: projectIds['Trường đại học Công nghệ'],
        issue_date: '2024-11-20',
        purpose: 'Xuất vật tư điện nước',
        approved_by: 'Phan Văn Hiệu Trưởng',
        items: [
          { material_code: 'ONG-NUOC-42', quantity: 300 },
          { material_code: 'DAY-DIEN-2.5', quantity: 1500 },
          { material_code: 'DAY-DIEN-4', quantity: 1000 }
        ]
      },
      {
        issue_number: 'PX-2024-020',
        project_id: projectIds['Khu liên hợp thể thao Đông Á'],
        issue_date: '2024-12-10',
        purpose: 'Xuất vật tư tổng hợp cho hoàn thiện',
        approved_by: 'Đinh Văn Trưởng Ban',
        items: [
          { material_code: 'XM-PC40', quantity: 200 },
          { material_code: 'THEP-D12', quantity: 2500 },
          { material_code: 'GACH-ON', quantity: 8000 },
          { material_code: 'SON-TRONG', quantity: 60 }
        ]
      }
    ];
